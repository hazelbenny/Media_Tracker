...
class MediaTracker:
    ...
    def save_data(self):
        ...
        with open(self.filename, 'w') as f:
            json.dump(self.media_list, f, indent=2)
    ...
    def add_item(self):
        ...
        # Category selection
        print("\nCategory:")
        categories = ["Book", "Movie", "TV Show", "Anime", "Podcast", "Other"]
        ...
        status = statuses[int(status_choice) - 1] if status_choice.isdigit() and 1 <= int(status_choice) <= 4 else statuses[0]
